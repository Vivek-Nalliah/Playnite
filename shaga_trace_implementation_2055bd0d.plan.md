---
name: Shaga Trace Implementation
overview: Transform Playnite into Shaga Trace with full rebranding, a new recording settings tab, background game process monitoring, DirectX-based in-game overlay, and C#-native video/audio/input recording using NVSDK/AMF encoders.
todos:
  - id: rebrand-core
    content: Rename solution/projects from Playnite to ShagaTrace, update assembly info
    status: pending
  - id: rebrand-assets
    content: Replace logos, icons, splash screen with Shaga branding
    status: pending
  - id: rebrand-localization
    content: Update localization strings and window titles
    status: pending
  - id: settings-model
    content: Create ShagaTraceRecordingSettings class with recording configuration
    status: pending
  - id: settings-ui
    content: Create ShagaTrace.xaml settings section and register in SettingsViewModel
    status: pending
  - id: process-monitor
    content: Implement GameProcessMonitor service for detecting game launches
    status: pending
  - id: video-capture
    content: Implement WGC and DXGI video capture backends
    status: pending
  - id: video-encoding
    content: Create NVSDK and AMF encoder wrappers via P/Invoke
    status: pending
  - id: audio-capture
    content: Implement WASAPI loopback capture and Opus encoding
    status: pending
  - id: input-recording
    content: Create InputRecorder for keyboard, mouse, gamepad events
    status: pending
  - id: session-manager
    content: Build RecordingSessionManager to coordinate all capture components
    status: pending
  - id: overlay-project
    content: Create ShagaTrace.Overlay project with DirectX hook DLL
    status: pending
  - id: overlay-ipc
    content: Implement named pipe IPC between main app and overlay
    status: pending
  - id: integration
    content: Integrate recording triggers with GamesEditor game start/stop events
    status: pending
---
